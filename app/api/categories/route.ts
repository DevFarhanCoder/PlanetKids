...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (formData.has('parentId')) updateData.parentId = formData.get('parentId') || null;
    if (formData.has('displayOrder')) updateData.displayOrder = parseInt(formData.get('displayOrder') as string);
