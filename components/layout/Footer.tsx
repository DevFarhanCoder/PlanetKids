...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-50 via-orange-50 to-pink-50 text-gray-700">
      {/* Newsletter Section */}
      <div className="bg-gradient-to-r from-primary-500 via-orange-500 to-pink-500 py-8 md:py-16">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
            <div className="text-white text-center md:text-left">
              <h3 className="text-xl md:text-3xl font-black mb-2 md:mb-3">
                Join Our Happy Parents Club! 🎉
              </h3>
              <p className="text-white/95 text-sm md:text-lg font-semibold">
            ...
            <div className="flex gap-2 md:gap-3 w-full md:w-auto">
              <input
                ...
                className="flex-1 md:w-80 px-4 md:px-6 py-3 md:py-4 rounded-xl md:rounded-2xl focus:outline-none focus:ring-2 md:focus:ring-4 focus:ring-white/50 shadow-soft-lg font-semibold placeholder:text-gray-500 text-sm md:text-base"
              />
              <button className="btn-secondary whitespace-nowrap shadow-soft-lg text-sm md:text-base px-4 md:px-6">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="container-custom py-8 md:py-16">
            ...
            <ul className={`space-y-3 md:space-y-4 ${openSection === 'contact' ? 'block' : 'hidden md:block'}`}>
              ...
              <li className="flex items-center gap-2 md:gap-3">
                ...
                <a
                  ...
                  className="text-xs md:text-sm hover:text-primary-600 transition-colors font-semibold"
                >
                  9326287112
                </a>
              </li>
        ...
        <div className="md:hidden mt-6 flex justify-center gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-white hover:bg-gradient-to-r hover:from-pink-400 hover:to-pink-500 rounded-xl flex items-center justify-center transition-all shadow-soft"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-white hover:bg-gradient-to-r hover:from-green-400 hover:to-green-500 rounded-xl flex items-center justify-center transition-all shadow-soft"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-white hover:bg-gradient-to-r hover:from-primary-400 hover:to-primary-500 rounded-xl flex items-center justify-center transition-all shadow-soft"
          >
      ...
      <div className="border-t border-gray-200 bg-white/50">
        <div className="container-custom py-4 md:py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4 text-sm">
            <p className="font-semibold text-gray-700 text-xs md:text-sm text-center md:text-left">
            ...
            <div className="flex flex-col md:flex-row items-center gap-3 md:gap-4">
              ...
              <div className="flex gap-2 md:gap-3 items-center">
                ...
                <Image
                  ...
                  className="h-6 md:h-8 w-auto object-contain"
                />
                <div className="bg-gradient-to-r from-success-500 to-success-600 px-2 md:px-3 py-1 md:py-2 rounded-lg text-xs font-black text-white">
                  COD
                </div>
              </div>
            </div>
