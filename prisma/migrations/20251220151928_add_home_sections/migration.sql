...
-- CreateEnum
CREATE TYPE "AgeGroup" AS ENUM ('ZERO_TO_ONE', 'ONE_TO_TWO', 'TWO_TO_FOUR', 'FOUR_TO_SIX', 'SIX_TO_EIGHT', 'EIGHT_PLUS');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('COD', 'PREPAID', 'CUSTOM_GATEWAY');
...
-- CreateEnum
CREATE TYPE "SectionType" AS ENUM ('GRID', 'CAROUSEL', 'TWO_COLUMN', 'FULL_WIDTH');
...
CREATE TABLE "HomeSection" (
    ...
    "displayOrder" INTEGER NOT NULL DEFAULT 0,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "sectionType" "SectionType" NOT NULL DEFAULT 'GRID',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Product_isActive_isFeatured_isNewArrival_isTrending_idx" ON "Product"("isActive", "isFeatured", "isNewArrival", "isTrending");
...
-- CreateIndex
CREATE INDEX "HomeSection_slug_idx" ON "HomeSection"("slug");
...
-- CreateIndex
CREATE INDEX "HomeSectionItem_isActive_idx" ON "HomeSectionItem"("isActive");

-- CreateIndex
CREATE INDEX "HomeSectionItem_displayOrder_idx" ON "HomeSectionItem"("displayOrder");
